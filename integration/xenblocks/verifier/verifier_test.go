...
func TestArgon2Hash(t *testing.T) {
	...
	require.Equal("$argon2id$v=19$m=8,t=1,p=1$WEVOMTAwODIwMjJYRU4$0kyTUOCcr1NOOnc8ynGWGGldI+8ssTIW5Xy3/VWztQ6YLC8p7llYzzUiEe7pgBk/aVKhjsDH6ArPSSDJng+KzA", hash)
}
